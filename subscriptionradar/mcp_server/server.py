...
from subscriptionradar.mcp_server.tools import (
    handle_recent_updates,
    handle_savings_report,
    handle_search,
    handle_sql,
    handle_top_trends,
)
...
def _list_tool_specs() -> list[dict[str, object]]:
    return [
        ...
        {
            "name": "savings_report",
            "description": "Analyze recent subscription news for price change alerts and cost-saving insights.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "days": {"type": "integer", "minimum": 1},
...
def create_app() -> _McpApp:
    ...
    app = server_ctor("subscriptionradar")
